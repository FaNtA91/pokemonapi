...
namespace Pokemon.Util
{
    ...
    public class ClientChooserOptions
    {
        ...
        /// <summary>
        /// Location of where to read/save the selected OT server. Default: %APPDATA%\PokemonApi\servers.xml.
        /// </summary>
        public string SavedServersLocation = System.IO.Path.Combine(Pokemon.Constants.TAConstants.AppDataPath, @"servers.xml");
