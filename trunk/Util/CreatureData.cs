...
namespace Pokemon.Util
{
    public static class CreatureData
    {
        ...
        public static void Run()
        {
            ...
            string url = "http://Pokemon.wikia.com/index.php?title=List_of_Creatures&printable=yes";
        ...
        private static void ParseCreatures(string html)
        {
            ...
            foreach (string name in names)
            {
                ...
                c.DownloadFileAsync(new Uri("http://Pokemon.wikia.com/index.php?title=" + name + "&printable=yes"), "pages\\" + name);
            }
