...
namespace Pokemon.Objects
{
    ...
    public class Item
    {
        ...
        /// <summary>
        /// Gets the total number of items/objects in Pokemon.
        /// </summary>
        ...
        public byte TopOrder
        {
            get
            {
                if (GetFlag(Pokemon.Addresses.DatItem.Flag.IsGround))
                    return 0;
                else if (GetFlag(Pokemon.Addresses.DatItem.Flag.TopOrder1))
                    return 1;
                else if (GetFlag(Pokemon.Addresses.DatItem.Flag.TopOrder2))
                    return 2;
                else if (GetFlag(Pokemon.Addresses.DatItem.Flag.TopOrder3))
                    return 3;
                else
                    return 5;
            }
